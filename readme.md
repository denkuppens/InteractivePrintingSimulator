...
This is a inkjet printing simulator which runs in locally in modern web browsers and can be used as an educational tool to see the effect of the most important parameters involved in functional and graphical inkjet printing. 
...
# Installation
Download the source from the repository (click the green 'Code' button above, then click 'Download ZIP'), unpack the zip file and open the file: <code>PrintSimulator.html</code> in your web browser.
